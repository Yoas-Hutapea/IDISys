{{--
    Detail Purchase Request Partial for Purchase Request Approval
        ...
        <div class="card-body">
            ...
            <div class="row mt-3">
                <div class="col-12 text-end">
                    ...
                    <input type="text" class="form-control d-inline-block" id="view-amount-total" value="-" disabled style="width: 200px;">
                </div>
            </div>
        </div>
    </div>
