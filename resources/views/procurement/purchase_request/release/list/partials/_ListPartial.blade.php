{{--
    List Partial for Purchase Request Release List
    Contains the table with release data and pagination
    Supports dark mode with proper Bootstrap classes
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  --}}

<div class="list-partial-content">
    <div class="table-responsive">
        <table class="table table-striped table-hover" id="releaseTable">
