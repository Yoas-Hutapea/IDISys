{{-- Approval Assignment Partial for View PR --}}
<div class="col-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" id="view-pr-approval-requestor" value="-" disabled>
                </div>
                <div class="col-sm-6">
                    <label class="form-label fw-semibold">Reviewed by</label>
                    <input type="text" class="form-control" id="view-pr-reviewed-by" value="-" disabled>
                </div>
                <div class="col-sm-6">
                    <label class="form-label fw-semibold">Applicant</label>
                    <input type="text" class="form-control" id="view-pr-approval-applicant" value="-" disabled>
                </div>
                <div class="col-sm-6">
