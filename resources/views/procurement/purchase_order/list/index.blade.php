...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y po-list-container">
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center py-3 mb-4">
                    <h5 class="fw-bold mb-0">
                        <span class="text-muted fw-light">Procurement /</span> Purchase Order List
                    </h5>
                </div>
            </div>
        </div>
        ...
        <section class="filter-section mb-4" aria-labelledby="filter-heading">
            ...
            <div class="filter-content" id="filter-content" role="region" aria-labelledby="filter-heading">
                @include('procurement.purchase_order.list.partials._FilterPartial')
            </div>
        </section>
        ...
        <section class="list-section" id="listSection" aria-labelledby="list-heading">
            <header class="list-header">
                ...
                <div class="d-flex align-items-center gap-3">
                    <button class="btn btn-success" id="exportExcelBtn" onclick="exportExcel('#poTable')" title="Export to Excel">
            ...
            @include('procurement.purchase_order.list.partials._ListPartial')
        </section>

        <section class="list-section" id="viewPOSection" style="display: none;" aria-labelledby="view-po-heading">
            <header class="list-header">
                <div class="d-flex align-items-center">
                    <h5 id="view-po-heading" class="fw-semibold mb-0">View Purchase Order</h5>
                </div>
                <div class="d-flex align-items-center gap-3">
...
@section('scripts')
    ...
    @include('shared.scripts.components._POListScriptsPartial')
@endsection
