<div class="list-partial-content">
    <div class="table-responsive">
        ...
        <table class="table table-striped table-hover" id="confirmPOTable">
            <thead class="table-light dark:table-dark">
                <tr>
                    <th width="50">
                        <input type="checkbox" id="selectAll" onclick="confirmPOManager.toggleSelectAll()">
                    </th>
