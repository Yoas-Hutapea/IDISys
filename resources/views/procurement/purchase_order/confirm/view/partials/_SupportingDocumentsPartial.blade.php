{{--
    Supporting Documents Partial for Confirm PO View
    Shows supporting documents table with preview and download actions (same as Receive PR)
--}}
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped table-hover" id="confirm-documents-table">
                    ...
                    <tbody id="confirm-documents-tbody">
