...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y posting-list-container">
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center py-3 mb-4">
                    <h5 class="fw-bold mb-0">
                        <span class="text-muted fw-light">Finance AP / E-Billing /</span> Posting Invoice
                    </h5>
                </div>
            </div>
        </div>
        ...
        <section class="filter-section mb-4" aria-labelledby="filter-heading">
            ...
            <div class="filter-content" id="filter-content" role="region" aria-labelledby="filter-heading">
                @include('finance.invoice.posting.partials._FilterPartial')
            </div>
        </section>
        ...
        <section class="list-section" id="listSection" aria-labelledby="list-heading">
            <header class="list-header">
                ...
                <div class="d-flex align-items-center gap-3">
                    <button class="btn btn-warning" id="processBulkPostBtn" onclick="processBulkPost()" disabled>
            ...
            @include('finance.invoice.posting.partials._ListPartial')
        </section>

        <section class="list-section" id="viewPostingSection" style="display: none;" aria-labelledby="view-posting-heading">
            <header class="list-header">
                <div class="d-flex align-items-center">
                    <h5 id="view-posting-heading" class="fw-semibold mb-0">Post Invoice</h5>
                </div>
                <div class="d-flex align-items-center gap-3">
            ...
            <div id="viewPostingContainer">
                @include('finance.invoice.posting.view._ViewPosting')
            </div>
        </section>
    </div>
@endsection
...
@section('scripts')
    @include('shared.scripts.components._PostingListScriptsPartial')
@endsection
