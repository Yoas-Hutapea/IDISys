/**
 * ApprovalListFilter Module
 * Handles filter functionality, search, and reset for Approval List
 */
class ApprovalListFilter {
    ...
    bindEvents() {
        ...
        if (startDateInput) {
            ...
            startDateInput.addEventListener('input', () => this.updateDateRangeInfo());
        }
        if (endDateInput) {
            endDateInput.addEventListener('change', () => this.updateDateRangeInfo());
            endDateInput.addEventListener('input', () => this.updateDateRangeInfo());
        }
    }
    ...
    debouncedSearch() {
        ...
        this.debounceTimer = setTimeout(() => {
            ...
            if (this.manager && this.manager.searchApproval) {
                this.manager.searchApproval();
            }
        }, 500);
    }
...
if (typeof window !== 'undefined') {
    window.ApprovalListFilter = ApprovalListFilter;
}
