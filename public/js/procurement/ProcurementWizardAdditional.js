    ...
    async loadAndFillAdditional(prNumber) {
        ...
        try {
            ...
            if (isBillingTypeSection) {
                ...
                if (billingTypeField && (additional.billingTypeId || additional.billingTypeID || additional.BillingTypeId || additional.BillingTypeID)) {
                    const billingTypeId = additional.billingTypeId || additional.billingTypeID || additional.BillingTypeId || additional.BillingTypeID;
            ...
            if (isSubscribeSection) {
                ...
                if (subscribeBillingTypeField && (additional.billingTypeId || additional.billingTypeID || additional.BillingTypeId || additional.BillingTypeID)) {
                    const subscribeBillingTypeId = additional.billingTypeId || additional.billingTypeID || additional.BillingTypeId || additional.BillingTypeID;
