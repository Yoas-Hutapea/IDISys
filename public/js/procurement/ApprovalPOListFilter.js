/**
 * ApprovalPOListFilter Module
 * Handles filter functionality, search, and reset for Approval PO List
 */
class ApprovalPOListFilter {
    ...
    buildFilter() {
        ...
        // Filter for Approval PO List: only show PO with status 9 or 10
        // Status 9 = Waiting Approval 1 Purchase Order (filtered by backend for "Account Payable, Treasury & Revenue Assurance Manager")
        // Status 10 = Waiting Approval 2 Purchase Order (filtered by backend for "Finance & Treasury Division Head")
        filter.mstApprovalStatusIDs = [9, 10];
    ...
    resetFilter() {
        ...
        // Reload table
        if (this.manager && this.manager.approvalPODataTable) {
            this.manager.approvalPODataTable.ajax.reload();
        } else if (this.manager && this.manager.tableModule && this.manager.tableModule.dataTable) {
            this.manager.tableModule.dataTable.ajax.reload();
        }
    }
...
if (typeof window !== 'undefined') {
    window.ApprovalPOListFilter = ApprovalPOListFilter;
}
